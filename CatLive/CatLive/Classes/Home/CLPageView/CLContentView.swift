...
@objc protocol CLContentViewDelegate : class {
    func contentView(_ contentView : CLContentView, progress : CGFloat, sourceIndex : Int, targetIndex : Int)
    
    @objc optional func contentViewEndScroll(_ contentView : CLContentView)
}
...
class CLContentView: UIView {
    ...
    // MARK: 对外属性
    weak var delegate : CLContentViewDelegate?
...
extension CLContentView : UICollectionViewDataSource {
...
extension CLContentView : UICollectionViewDelegate {
